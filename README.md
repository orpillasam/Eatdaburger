...
A full stack web app, using Handlebars.  We display burgers from our database, which can be changed to "devoured" after a devour button is clicked, which moves the burger to a devoured screen.

I found Handlebars to be unintuitive, but i was able to get the app to work. Looking forward to using learning React instead!
